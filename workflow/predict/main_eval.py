...
if __name__ == '__main__':
    ...
    parser.add_argument('--experiment', type=str, help='choose a pretrained model', default='msnet_20220427_141044')
    parser.add_argument('--epoch', type=int, help='choose the epoch of saved model', default=1000)
